...
<div class="costo" id="costo" style="display:none">
  <div class="costo_content">
    <span class="precio">Cirka pris:</span>
    <span class="monto"></span> Kr
<br>
    <span class="montoimp"></span> Kr
    ...
    <div class="ab-mobile-step_1 ab-row-fluid">
      <div class="ab-formGroup ab-category ab-left">
        <label class="ab-formLabel">
          <?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_category' ) ?>
        </label>
      ...
      <div class="ab-formGroup ab-Postnummer ab-left">
        <label class="ab-formLabel">Postnummer</label>
        <div class="ab-formField">
          <input type="text" class="ab-formElement ab-user-notes ab-custom-field" name="ab-custom-field-41970" value="" id="Postnummer">
        </div>
        <div class="ab-label-error ab-custom-field-error ab-custom-field-41970-error"></div>
      </div>

      <div class="ab-formGroup ab-number-of-persons ab-left">
        <label class="ab-formLabel">
          <?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_number_of_persons' ) ?>
        </label>
        <div class="ab-formField">
      <!--       <select class="ab-formElement ab-select-mobile ab-select-number-of-persons">
                <option value="1">1</option>
            </select> -->
          <input class="ab-formElement ab-select-mobile ab-select-number-of-persons" id="nop" type="text" name="nop" maxlength="5000"><br>
        </div>
      </div>
      <div class="ab-formGroup ab-employee ab-left">
        <label class="ab-formLabel">
          <?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_employee' ) ?>
        </label>
        <div class="ab-formField">
    ...
    <div class="ab-mobile-step_2">
      <div class="ab-row-fluid">
        <div class="ab-left ab-available-date ab-formGroup ab-lastGroup" style="width: auto">
          <label class="ab-nowrap ab-bold">
            <?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_select_date' ) ?>
          </label>
        ...
        <div class="ab-left ab-time-range">
          <div class="ab-left ab-time-from">
              <label class="ab-bold">
                <?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_start_from' ) ?>
              </label>
              <div>
          ...
          <div class="ab-left ab-time-to">
            <label class="ab-bold">
              <?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_finish_by' ) ?>
            </label>
            <div>
