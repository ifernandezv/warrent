    ...
    <div class="ab-payment">
        ...
        <div style="margin-bottom: 15px">
            ...
            <div class="ab-inline-block">
                ...
                <button class="ab-btn ladda-button ab-inline-block"><?php _e( 'Apply', 'bookly' ) ?></button>
            </div>
        </div>
        ...
        <?php if ( get_option( 'ab_2checkout' ) == 1 ) : ?>
        <div class="ab-row-fluid">
            <label>
                <input type="radio" name="payment" class="ab-2checkout-payment" value="2checkout"/>
                <?php echo get_option( 'ab_appearance_text_label_pay_ccard' ) ?>&nbsp;2Checkout
                <img style="margin-left: 10px;" src="<?php echo plugins_url( 'frontend/resources/images/cards.png', AB_PATH . '/main.php' ) ?>" alt="cards" />
            </label>
        </div>
        <?php endif ?>
