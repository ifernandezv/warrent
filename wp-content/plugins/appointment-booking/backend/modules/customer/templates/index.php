        ...
        <div ng-app="customers" ng-controller="customersCtrl" class="form-horizontal ng-cloak">
            ...
            <div class="table-responsive">
                <table id="ab_customers_list" class="table table-striped" cellspacing=0 cellpadding=0 border=0 style="clear: both;">
                    <thead>
                    <tr>
                        <th style="width: 150px" ng-class=css_class.name><a href="" ng-click=reload({sort:'name'})><?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_name' ) ?></a></th>
                        <th style="width: 150px" ng-class=css_class.wp_user><a href="" ng-click=reload({sort:'wp_user'})><?php _e( 'User', 'bookly' ) ?></a></th>
                        <th style="width: 100px" ng-class=css_class.phone><a href="" ng-click=reload({sort:'phone'})><?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_phone' ) ?></a></th>
                        <th style="width: 250px" ng-class=css_class.email><a href="" ng-click=reload({sort:'email'})><?php echo AB_Utils::getTranslatedOption( 'ab_appearance_text_label_email' ) ?></a></th>
