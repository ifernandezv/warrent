...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="ab-wrapper-container">
            <?php AB_Utils::notice( $errors, 'notice-error' ) ?>
            <?php AB_Utils::notice( $messages ) ?>
            ...
            <?php if ( $is_logged_in ) : ?>
                ...
                <div>
                    <ul class="nav nav-tabs" id="sms_tabs">
                        <li class=""><a data-toggle="tab" href="#notifications"><?php _e( 'Notifications', 'bookly' ) ?></a></li>
                        <li class=""><a data-toggle="tab" href="#add_money"><?php _e( 'Add money', 'bookly' ) ?></a></li>
                        <li class=""><a data-toggle="tab" href="#purchases"><?php _e( 'Purchases', 'bookly' ) ?></a></li>
                        <li class=""><a data-toggle="tab" href="#sms_details"><?php _e( 'SMS Details', 'bookly' ) ?></a></li>
                        <li class=""><a data-toggle="tab" href="#price"><?php _e( 'Price list', 'bookly' ) ?></a></li>
                    </ul>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <?php AB_Utils::submitButton( 'ajax-send-change-password' ) ?>
