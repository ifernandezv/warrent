...
<div id="ab-annual-calendar-scroll" style="text-align: center; max-width: 715px;">
    <div class="input-prepend input-append form-inline">
        ...
        <input style="width: 70px; text-align: center; background: white; display: inline-block;" class="jcal_year form-control" readonly="readonly" id="appendedPrependedInput" size="16" type="text" value="">
