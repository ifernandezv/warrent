...
abstract class AB_Config
{
    ...
    public static function getCaSeSt()
    {
        ...
        foreach ( $rows as $row ) {
            if ( ! isset( $result['services'][ $row['service_id'] ] ) ) {
                ...
                $result['services'][ $row['service_id'] ]['max_capacity'] = $row['price'];
            }
            ...
            if ( ! isset ( $result['staff'][ $row['staff_id'] ]['services'][ $row['service_id'] ] ) ) {
                ...
                unset ( $service['staff'] );
                $service['max_capacity'] = $row['price'];
    ...
    {
        return array( 'AUD', 'BRL', 'CAD', 'CHF', 'CLP', 'COP', 'CZK', 'DKK', 'EUR', 'GBP', 'GTQ', 'HKD', 'HUF', 'IDR', 'ILS', 'INR', 'JPY', 'KRW', 'KZT', 'MXN', 'MYR', 'NOK', 'NZD', 'PEN', 'PHP', 'PLN', 'QAR', 'RMB', 'RON', 'RUB', 'SAR', 'SEK', 'SGD', 'THB', 'TRY', 'TWD', 'UGX', 'USD', 'ZAR' );
    }
