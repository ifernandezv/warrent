...
function nictitate_lite_init_options($options){
	...
	$options['settings'][] = array(
		'settings'    => 'nictitate_lite_options_email_address',
		'label'       => esc_html__('Contact Information', 'nictitate-lite'),
		'default'     => '',
		'description' => esc_html__('EMAIL', 'nictitate-lite'),
		'type'        => 'text',
		'section'     => 'nictitate_lite_section_general_setting',
		'transport'   => 'refresh');
	#5. Contact Information - Phone
	$options['settings'][] = array(
		'settings'    => 'nictitate_lite_options_phone_number',
		'label'       => esc_html__('Contact Information', 'nictitate-lite'),
		'default'     => '',
		'description' => esc_html__('PHONE NUMBER', 'nictitate-lite'),
		'type'        => 'text',
		'section'     => 'nictitate_lite_section_general_setting',
		'transport'   => 'refresh');
	#6. Contact Information - Address
	$options['settings'][] = array(
		'settings'    => 'nictitate_lite_options_address',
		'label'       => esc_html__('Contact Information', 'nictitate-lite'),
		'default'     => '',
		'description' => esc_html__('ADDRESS', 'nictitate-lite'),
		'type'        => 'text',
		'section'     => 'nictitate_lite_section_general_setting',
		'transport'   => 'refresh');
