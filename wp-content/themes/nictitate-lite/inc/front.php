...
function nictitate_lite_front_after_setup_theme() {
    ...
    if (!is_admin()) {
        ...
        add_action('wp_head', 'nictitate_lite_ie_js_header');
        add_filter('widget_text', 'do_shortcode');
        add_filter('get_the_excerpt', 'nictitate_lite_get_the_excerpt');
        ...
        add_action( 'admin_enqueue_scripts', 'nictitate_lite_admin_front_enqueue_scripts' );
...
function nictitate_lite_front_enqueue_scripts() {
    if (!is_admin()) {
        ...
        wp_enqueue_style('font-rokkitt', '//fonts.googleapis.com/css?family=Rokkitt', array(), NULL);
        wp_enqueue_style('font-open-san', '//fonts.googleapis.com/css?family=Open+Sans', array(), NULL);
        wp_enqueue_style('font-raleway', '//fonts.googleapis.com/css?family=Raleway:400,600,500', array(), NULL);
        ...
        wp_enqueue_script('modernizr', $dir . '/js/modernizr.custom.js');
        ...
        wp_enqueue_script('superfish-js', $dir . '/js/superfish.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('kopa-retina', $dir . '/js/retina.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('bootstrap-js', $dir . '/js/bootstrap.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('kopa-hoverdir', $dir . '/js/jquery.hoverdir.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('carouFredSel', $dir . '/js/jquery.carouFredSel-6.0.4-packed.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('flexlisder-js', $dir . '/js/jquery.flexslider-min.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('prettyPhoto-js', $dir . '/js/jquery.prettyPhoto.js', array('jquery'), NULL, TRUE);
        wp_enqueue_script('jflickrfeed', $dir . '/js/jflickrfeed.min.js', array('jquery'), NULL, TRUE);
...
function nictitate_lite_admin_front_enqueue_scripts() {
    wp_enqueue_style('bootstrap', get_template_directory_uri() . '/inc/assets/css/admin.css', array(), NULL, 'screen');
}
...
function nictitate_lite_breadcrumb() {
    if (is_main_query()) {
        ...
        $breadcrumb_home = '<a href="' . home_url('/') . '">' . __('Home', 'nictitate-lite') . '</a>';
        $breadcrumb = '';
        ?>
...
function nictitate_lite_get_the_excerpt($excerpt) {
    if (is_main_query()) {
...
function nictitate_lite_get_video_thumbnails_url($type, $url) {
    $thubnails = '';
    $matches = array();
    if ('youtube' === $type) {
...
function nictitate_lite_ie_js_header() {
    echo '<!--[if lt IE 9]>' . "\n";
